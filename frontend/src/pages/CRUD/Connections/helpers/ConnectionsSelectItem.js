...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/connections/autocomplete`, { params });
  return response.data;
}

const ConnectionsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.connections.hasPermissionToCreate,
});

export default connect(select)(ConnectionsSelectItem);
