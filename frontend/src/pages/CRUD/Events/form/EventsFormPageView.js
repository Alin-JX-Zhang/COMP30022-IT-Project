...
import EventsFormView from 'pages/CRUD/Events/form/EventsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/events/eventsFormActions';
import { connect } from 'react-redux';

const EventsFormPageView = (props) => {
...
export default connect(mapStateToProps)(EventsFormPageView);
